...
public class Entrydocumentinspection implements Serializable {
    ...
    @JoinTable(name = "entrydocumentinspection_shippingcontainer", joinColumns = {
        @JoinColumn(name = "EntryDocumentInspection_ID", referencedColumnName = "ID")}, inverseJoinColumns = {
        @JoinColumn(name = "shippingContainers_ID", referencedColumnName = "ID")})
    @ManyToMany
    private List<Shippingcontainer> shippingcontainerList;
    ...
    @XmlTransient
    @JsonIgnore
    public List<Shippingcontainer> getShippingcontainerList() {
        return shippingcontainerList;
    }

    public void setShippingcontainerList(List<Shippingcontainer> shippingcontainerList) {
        this.shippingcontainerList = shippingcontainerList;
    }
    ...
    public String toString() {
        return "jm.com.dpba.business.entity.utils.Entrydocumentinspection[ id=" + id + " ]";
    }
