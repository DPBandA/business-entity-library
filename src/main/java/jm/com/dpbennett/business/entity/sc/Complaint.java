...
public class Complaint implements Comparable, BusinessEntity {
    ...
    private static final System.Logger LOG = System.getLogger(Complaint.class.getName());
    ...
    private LocalDateTime dateOfCorrespondence;
    ...
    public LocalDateTime getDateOfCorrespondence() {
        return dateOfCorrespondence;
    }

    public void setDateOfCorrespondence(LocalDateTime dateOfCorrespondence) {
