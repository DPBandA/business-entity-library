...
public class PhoneNumber implements BusinessEntity {

    private static final long serialVersionUID = 1L;
    private static final System.Logger LOG = System.getLogger(PhoneNumber.class.getName());
    @Id
    ...
    public ReturnMessage save(EntityManager em) {
        try {
            ...
            System.out.println("Phone number save exception: " + e);
        }

        return new ReturnMessage(false, "Phone number not saved");
    }
